//hacer q no se mesclen las variables en todos los archivos de js - todo lo q esta adentro solo se puede usar en ese arcivo
// (function() {
    ...
    function mostrarFormulario(editar = false, tarea = {}) {
        ...
        modal.addEventListener('click', function(e) {
            ...
            if(e.target.classList.contains('submit-nueva-tarea')) {
                const nombreTarea = document.querySelector('#tarea').value.trim(); //trim borra espacios al inicio y al final

                if(nombreTarea === '') {
                    //si esta vacio mostrar alerta de error 
